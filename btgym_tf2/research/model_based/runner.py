...
class OUpRunner(BaseSynchroRunner):
    ...
    def __init__(self, name='OUp_synchro', **kwargs):
        ...
        self.dgp_params = {key: [] for key in self.env.observation_space._shape['metadata']['generator'].keys()}
        self.dgp_dict = {key: 0 for key in self.env.observation_space._shape['metadata']['generator'].keys()}
