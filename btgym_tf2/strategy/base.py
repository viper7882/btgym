...
from btgym_tf2.strategy.utils import norm_value, decayed_result, exp_scale
...
class BTgymBaseStrategy(bt.Strategy):
    ...
    params = dict(
        ...
        # one can define any shape; should match env.observation_space._shape.
    ...
    def __init__(self, **kwargs):
        ...
        # time forward (see: btgym_tf2.server._BTgymAnalyzer.next() method);
    ...
    def next(self):
        ...
        `self.action` attr. is updated by btgym_tf2.server._BTgymAnalyzer, and `None` actions
    ...
    def get_info(self):
        ...
        Note:
            ...
            just latest one, [info[0]]. This behaviour is set inside btgym_tf2.server._BTgymAnalyzer().next() method.
        """
        return dict(
            step=self.iteration,
    ...
    def _next_discrete(self, action):
        ...
        Args:
            action:     dict, string encoding of btgym_tf2.spaces.ActionDictSpace
