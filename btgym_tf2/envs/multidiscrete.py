...
from btgym_tf2.envs.base import BTgymEnv
...
class MultiDiscreteEnv(BTgymEnv):
    ...
    Multi-asset setup explanation:
        ...
        3. btgym_tf2.spaces.ActionDictSpace and order execution. Strategy expects to receive separate action
    ...
    def __init__(self, engine, dataset=None, **kwargs):
        ...
        Args:
            dataset(btgym_tf2.datafeed):                        BTgymDataDomain instance;
