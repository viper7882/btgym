...
from btgym_tf2.algorithms.rollout import Rollout
from btgym_tf2.algorithms.memory import _DummyMemory
from btgym_tf2.algorithms.math_utils import softmax
from btgym_tf2.algorithms.utils import is_subdict
...
class BaseSynchroRunner():
    ...
    def get_init_experience(self, policy, policy_sync_op=None, init_context=None, data_sample_config=None):
        ...
        Args:
            ...
            data_sample_config:     configuration dictionary of type `btgym_tf2.datafeed.base.EnvResetConfig`
