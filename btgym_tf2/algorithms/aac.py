...
from btgym_tf2.algorithms.memory import Memory
from btgym_tf2.algorithms.rollout import make_data_getter
from btgym_tf2.algorithms.runner import BaseEnvRunnerFn, RunnerThread
from btgym_tf2.algorithms.math_utils import log_uniform
from btgym_tf2.algorithms.nn.losses import value_fn_loss_def, rp_loss_def, pc_loss_def, aac_loss_def, ppo_loss_def
from btgym_tf2.algorithms.utils import feed_dict_rnn_context, feed_dict_from_nested, batch_stack
from btgym_tf2.spaces import DictSpace as BaseObSpace
from btgym_tf2.spaces import ActionDictSpace as BaseAcSpace
...
class BaseAAC(object):
    ...
    def get_sample_config(self, _new_trial=True, **kwargs):
        ...
        Returns:
            configuration dictionary of type `btgym_tf2.datafeed.base.EnvResetConfig`
        """
        ...
        # Compose btgym_tf2.datafeed.base.EnvResetConfig-consistent dict:
        sample_config = dict(
            episode_config=dict(
                get_new=True,
    ...
    def _process_rollouts(self, rollouts):
        ...
        Args:
            rollouts:   list of btgym_tf2.algorithms.Rollout class instances
