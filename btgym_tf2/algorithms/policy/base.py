...
from btgym_tf2.algorithms.math_utils import sample_dp, softmax
from btgym_tf2.datafeed.base import EnvResetConfig
...
class BaseAacPolicy(object):
    ...
    def __init__(self,
        ...
        # Conv. layers:
        on_aac_x = conv_2d_network(self.on_state_in['external'], self.ob_space._shape['external'], ac_space, **kwargs)
        ...
        off_aac_x = conv_2d_network(self.off_state_in['external'], self.ob_space._shape['external'], ac_space, reuse=True, **kwargs)
        ...
        [self.pc_change_state_in, self.pc_change_last_state_in, self.pc_target] =\
            pixel_change_2d_estimator(self.ob_space._shape['external'], **kwargs)
        ...
        # Shared conv. output:
        rp_x = conv_2d_network(self.rp_state_in['external'], self.ob_space._shape['external'], ac_space, reuse=True, **kwargs)
    ...
    def get_sample_config(*args, **kwargs):
        ...
        Returns:
                default data sample configuration dictionary `btgym_tf2.datafeed.base.EnvResetConfig`
        """
